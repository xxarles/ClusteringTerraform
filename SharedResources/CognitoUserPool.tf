resource "aws_cognito_user_pool" "image_clustering_user_pool_dev" {
  name = "ImageClusteringUserPool"
...
resource "aws_cognito_user_pool_domain" "iamge_clustering_domain" {
